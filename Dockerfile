...
RUN apt update && apt upgrade -y && install sudo
RUN curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo VERSION=0.61.1 /usr/local/bin/newrelic install

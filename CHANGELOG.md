...
## [5.17.266] - 2026-09-05
### Fixed
- blog: publish - The Transaction State Your Block Explorer Can't See Yet


## [5.17.265] - 2026-08-23
### Fixed
- blog: publish - The DEX Trade That Was Never on a DEX
...
## [5.17.260] - 2026-07-31
### Fixed
- fix(sync): stop the integrity check rescan storm and make queue drops visible (#1360)


## [5.17.259] - 2026-07-31
### Fixed
- chore(sentry): remove the triage agent's production database access (#1359)
...
## [5.17.251] - 2026-07-27
### Fixed
- feat(monitoring): alert on replication lag and stalled WAL archiving (#1351)


## [5.17.250] - 2026-07-27
### Fixed
- fix(config): make DB and Redis IP family configurable for IPv6 networks (#1350)


## [5.17.249] - 2026-07-26
### Fixed
- blog: publish - After the Scanner Runs: The Audit Workflow Step That Lets Logical Vulnerabilities Through


## [5.17.248] - 2026-07-24
### Fixed
- blog: publish - The Mempool Rule That Blocked Privacy Pools: How EIP-8272 Works Around It


## [5.17.247] - 2026-07-22
### Fixed
- blog: publish - The Execution Window Your Reentrancy Guard Leaves Open


## [5.17.246] - 2026-07-20
### Fixed
- blog: publish - ERC-8004: The Registry Under the Agent Economy


## [5.17.245] - 2026-07-16
### Fixed
- blog: publish - Expire at Midnight: EIP-8130 Session Keys, Expiry, and Policy Gates


## [5.17.244] - 2026-07-16
### Fixed
- fix(retention): paginate workspaceReset by indexed id, drop 30s timeout (#1347)
...
## [5.17.241] - 2026-07-12
### Fixed
- blog: publish - The 2x Mint: When Wrapping a Token Creates Its Own Liquidity


## [5.17.240] - 2026-07-08
### Fixed
- blog: publish - The Triage Problem: Why Your Smart Contract Scanner's 87 Findings Contain One Real Bug


## [5.17.239] - 2026-07-06
### Fixed
- blog: publish - The 22-Byte Tax on Every Solidity Addition (And How EIP-8219 Ends It)


## [5.17.238] - 2026-07-04
### Fixed
- blog: publish - The Transfer Event Ethereum Was Missing: How EIP-7708 Makes ETH Observable


## [5.17.237] - 2026-07-02
### Fixed
- blog: publish - Lanes, Not Lines: EIP-8130's 2D Nonce Channels and Nonce-Free Mode


## [5.17.236] - 2026-06-30
### Fixed
- blog: publish - The Payer That Can't Send: EIP-8130's Owner Scope Model
...
## [5.17.232] - 2026-06-24
### Fixed
- blog: publish - The Prover Ran. The Property Was Wrong.


## [5.17.231] - 2026-06-22
### Fixed
- blog: publish - The Implicit Rule Your Auditor Couldn't Check


## [5.17.230] - 2026-06-20
### Fixed
- blog: publish - The Attack Window Your Audit Can't Close: Proxy Security Beyond Code Review


## [5.17.229] - 2026-06-18
### Fixed
- blog: publish - The Free Option Hidden in ePBS: Why Builders Can Walk Away From a Committed Block


## [5.17.228] - 2026-06-16
### Fixed
- blog: publish - Why the Ethereum Blobpool Consumes 4x More Bandwidth Than the Consensus Layer


## [5.17.227] - 2026-06-14
### Fixed
- blog: publish - The EVM Has No CALL/RET. Here's What It Costs Every L2.


## [5.17.226] - 2026-06-12
### Fixed
- blog: publish - Your NVMe Is Fast. Your Ethereum Node Doesn't Care.


## [5.17.225] - 2026-06-10
### Fixed
- blog: publish - The Sync That Never Finishes: How snap/2 Replaces Trie Healing


## [5.17.224] - 2026-06-08
### Fixed
- blog: publish - The Call Graph Your Auditor Never Drew


## [5.17.223] - 2026-06-06
### Fixed
- feat(blog-pipeline): scored GEO quality gate + source verification (Phase 6) (#1334)
...
## [5.17.220] - 2026-06-06
### Fixed
- ci(blog): activate search-feedback layer in trend-scan workflow (#1330)


## [5.17.219] - 2026-06-06
### Fixed
- feat(blog-pipeline): search-feedback layer — GSC signals + DataForSEO keyword enrichment + SERP hints (#1329)


## [5.17.218] - 2026-06-05
### Fixed
- fix(seo): retarget 19 chain pages for '<chain> explorer' queries (#1328)


## [5.17.217] - 2026-06-05
### Fixed
- feat(seo): search-feedback sprint — GSC-driven CTR rewrites, converter/explorer targeting, launch page (#1327)


## [5.17.216] - 2026-06-04
### Fixed
- blog: publish - The Agent Franchise Model: How ERC-8170's Genesis Contract Makes AI Ownership Trustless


## [5.17.215] - 2026-06-02
### Fixed
- blog: publish - The Callability Gap: Why Smart Contracts Still Can't Trade Like Professionals


## [5.17.214] - 2026-05-30
### Fixed
- blog: publish - After the Audit: The Monitoring Stack That Catches What Static Analysis Can't


## [5.17.213] - 2026-05-28
### Fixed
- blog: publish - The Oracle Your Auditor Can't Read
...
## [5.17.210] - 2026-05-25
### Fixed
- chore(tweet-pipeline): deactivate via repo-level kill switch (#1315)
...
## [5.17.207] - 2026-05-25
### Fixed
- feat: pipeline resilience — tweet circuit breaker + Sentry scanner preflight (#1309)


## [5.17.206] - 2026-05-25
### Fixed
- fix(rpc): swallow Substrate-EVM DispatchError (-32603) in tracer (#1306)


## [5.17.205] - 2026-05-20
### Fixed
- blog: regenerate 8 covers missed by the bespoke-prompt batch (#1294)


## [5.17.204] - 2026-05-20
### Fixed
- blog: publish - After Governance Capture: The Math of ETH-Staked Oracle Security


## [5.17.203] - 2026-05-19
### Fixed
- feat(blog): bespoke per-article cover image prompts (#1293)


## [5.17.202] - 2026-05-18
### Fixed
- blog: publish - The Agent That Can't Prove What It Did
...
## [5.17.199] - 2026-05-12
### Fixed
- blog: publish - The EVM Has No Subroutines. Here's Why That's a ZK Problem, and the Fix


## [5.17.198] - 2026-05-10
### Fixed
- blog: publish - When the Oracle Is the Attack: Governance Capture in Prediction Markets
...
## [5.17.192] - 2026-05-02
### Fixed
- Remove typing indicator cursor from terminal display (#1281)
- blog: publish - The Missing Verb: How ERC-8165 Gives AI Agents an Execution Model


## [5.17.191] - 2026-04-30
### Fixed
- Auto-close queue monitoring alerts and cap demo plans (#1277)


## [5.17.190] - 2026-04-28
### Fixed
- fix(queueCaps): lazy-require models to break circular import (#1271)


## [5.17.189] - 2026-04-28
### Fixed
- fix(test): drop requireActual on queueCaps in queue.test.js (#1269)


## [5.17.188] - 2026-04-28
### Fixed
- feat(queue): per-workspace cap for low-tier workspaces (#1268)
...
## [5.17.184] - 2026-04-24
### Fixed
- fix(rpc): widen debug_traceTransaction timeout window from 5m to 1h
- fix(lpworker): serialize cascade-delete jobs to prevent lock storms (#1245)


## [5.17.183] - 2026-04-24
### Fixed
- fix(seo): emit real newlines in tenant robots.txt via heredoc (#1235)
...
## [5.17.178] - 2026-04-20
### Fixed
- blog: publish - The Attack Taxonomy DeFi Security Has Been Ignoring


## [5.17.177] - 2026-04-19
### Fixed
- feat(emails): redesign demo drip email sequence (#1215)
- chore(security): add CODEOWNERS to gate PR approvals to @antoinedc (#1213)
...
## [5.17.174] - 2026-04-18
### Fixed
- fix: improve foreign key constraint error detection in receiptSync (#1207)


## [5.17.173] - 2026-04-18
### Fixed
- blog: publish - The Agent That Owns Itself: How ERC-8181 Builds Self-Sovereign AI on EVM


## [5.17.172] - 2026-04-17
### Fixed
- feat(seo): foundation sprint, canonical fix + pillar links + meta rewrites + perf (#1199)


## [5.17.171] - 2026-04-17
### Fixed
- fix: optimize TokenTransfer afterBulkCreate to prevent N+1 queries (#1198)
...
## [5.17.165] - 2026-04-16
### Fixed
- Remove FOR UPDATE lock in receipt sync to eliminate DB lock contention causing queue buildup

## [5.17.164] - 2026-04-15
### Fixed
- fix: remove statement_timeout and reduce pool to 20
...
## [5.17.160] - 2026-04-15
### Fixed
- fix: prevent database connection drops with keepAlive, retry, and graceful shutdown (#1102)
- fix: blog pipeline stuck when all topics are published (#1095)
...
## [5.17.156] - 2026-04-04
### Fixed
- blog: publish - The Provenance Gap: Why Smart Contracts Can't See NFT Transfer History


## [5.17.155] - 2026-04-03
### Fixed
- fix: sync tweet pipeline with server, fix audit phase permission crash (#1077)
...
## [5.17.152] - 2026-04-03
### Fixed
- fix: handle null block in Transaction.safeCreateReceipt (#1069)


## [5.17.151] - 2026-04-02
### Fixed
- fix: optimize receiptSync query performance by selecting only needed columns (#1067)
...
## [5.17.148] - 2026-04-02
### Fixed
- blog: publish - The State Growth Tax: Inside Ethereum's Proposal to Charge You for Dormant State


## [5.17.147] - 2026-04-01
### Fixed
- chore: remove Hetzner maintenance banner and page (#1046)


## [5.17.146] - 2026-04-01
### Fixed
- fix: resolve race condition in contract creation (#1045)
...
- fix: mount marketing router unconditionally


## [5.17.143] - 2026-03-30
### Fixed
- fix: address Sentry issues #1034, #1035, #1036 (#1038)


## [5.17.142] - 2026-03-30
### Fixed
- fix: add null/type check for data.domain before calling endsWith() (#1037)
...
- fix: preserve cached workspace data in blockSync retry logic (#976)


## [5.17.136] - 2026-03-29
### Fixed
- fix: add validation for rpcServer parameter in workspace settings (#967)


## [5.17.135] - 2026-03-28
### Fixed
- fix: add validation and error handling for Soketi WebSocket connections (#965)
...
- fix: add missing compound index for removeStalledBlock query optimization (#892)


## [5.17.129] - 2026-03-26
### Fixed
- fix: prevent processDetectedProspects queue enqueue on self-hosted instances (#887)


## [5.17.128] - 2026-03-26
### Fixed
- fix(prospecting): fix L2Beat scraper for actual API response format
- fix: add missing queue definitions for prospect processing jobs (#884)
- fix: add missing processDetectedProspects and enrichProspect queues (#885)


## [5.17.127] - 2026-03-26
### Fixed
- perf: tune Sequelize pool to reduce connection churn (#881)
- fix: add admin package-lock.json for Caddy Docker build
...
## [5.17.124] - 2026-03-25
### Fixed
- feat: add RB2B visitor identification to blog
- feat: add RB2B visitor identification to landing page


## [5.17.123] - 2026-03-25
### Fixed
- feat: add maintenance banner and page for Hetzner network maintenance (April 1) (#876)


## [5.17.122] - 2026-03-25
### Fixed
- fix: force IPv4 database connections to prevent ENETUNREACH errors (#871)


## [5.17.121] - 2026-03-25
### Fixed
- fix: complete connection leak fixes in additional safeDestroy methods (#870)
...
## [5.17.118] - 2026-03-24
### Fixed
- blog: add draft - The Frame Wallet: What EIP-8141 Means for Every EOA
- feat(landing): free developer tools - calldata decoder, 4byte lookup, unit converter, block date converter (#855)
- fix(blog-pipeline): reset working tree before pull to prevent recurring failures
- perf: incremental integrity check scan to reduce CPU spikes (#848)


## [5.17.117] - 2026-03-23
### Fixed
- Marketing pipeline improvements + competitor comparison pages (#842)
...
- fix: throw on invalid job params instead of silent return (#808)


## [5.17.105] - 2026-03-21
### Fixed
- fix: install ethernal-light from git tag with workspaceId fix (#807)
...
## [5.17.102] - 2026-03-21
### Fixed
- blog: add best block explorers for EVM chains comparison (#801)


## [5.17.101] - 2026-03-21
### Fixed
- fix: prevent N+1 queries in blockSync via batchBlockSync backward compatibility path (#800)


## [5.17.100] - 2026-03-20
### Fixed
- feat(tweet-pipeline): replace flat-file state with SQLite (#798)


## [5.17.99] - 2026-03-20
### Fixed
- fix(contact): differentiate email subject for contact page vs enterprise


## [5.17.98] - 2026-03-20
### Fixed
- feat(landing): redesign contact page with two-panel layout
...
- fix(tweet-pipeline): raise dedup threshold to reduce false positives
...
## [5.17.91] - 2026-03-20
### Fixed
- fix: validate block number parameter to prevent database type casting error (#782)
...
- fix: eliminate N+1 query in blockSync workspace browser sync update (#760)


## [5.17.86] - 2026-03-18
### Fixed
- fix(pipeline): use --autostash on promote-blog git pull
- docs: note that blog/landing auto-deploys on push to develop
- fix(blog): regenerate EIP-8130 cover images with blue-themed chips
- docs: add llms.txt update instructions to CLAUDE.md and LANDING.md
- feat(blog): auto-regenerate llms.txt on article publish
- feat(seo): add llms.txt for landing and blog
- chore: gitignore superpowers skills and session artifacts
...
## [5.17.82] - 2026-03-17
### Fixed
- fix: gracefully handle connection errors in native token balance API (#749)


## [5.17.81] - 2026-03-17
### Fixed
- fix(tweet-pipeline): newsletter scanner Claude scoring failure (#747)


## [5.17.80] - 2026-03-17
### Fixed
- docs: update Claude auth setup in MARKETING.md (#744)
...
- chore(blog): remove blog-draft.yml GitHub Actions workflow
- fix(blog): add id-token permission and fix allowed_tools for claude-code-action
- fix(blog): use GH_PAT instead of GITHUB_TOKEN for project API calls


## [5.17.75] - 2026-03-17
### Fixed
- feat(tweets): add writing quality rules to draft prompt
- feat(tweets): add references, inline links, and @mentions to tweet pipeline


## [5.17.74] - 2026-03-17
### Fixed
- fix(emails): replace broken logo image with text in drip email header
...
- fix(blog): regenerate cover image without text/numbers, update prompt


## [5.17.71] - 2026-03-16
### Fixed
- fix: handle Opsgenie API failures gracefully in queue monitoring (#733)
- fix: eliminate N+1 query regression in blockSync L2 config cache detection (#731)


## [5.17.70] - 2026-03-16
### Fixed
- fix(blog+tweets): fix markdown rendering issues and tweet image text overflow


## [5.17.69] - 2026-03-16
### Fixed
- fix(deploy): improve semver rules to correctly detect minor bumps
...
## [5.17.61] - 2026-03-16
### Fixed
- fix: include workspace id in processTransactionTrace job query (#711)
...
## [5.17.59] - 2026-03-15
### Fixed
- Change publication date to March 14, 2026 (#706)
...
## [5.17.54] - 2026-03-14
### Fixed
- fix: add null check for req.body.data in POST /api/users (#695)
...
## [5.17.50] - 2026-03-13
### Fixed
- fix: optimize processTransactionTrace query to reduce JOIN complexity (#679)


## [5.17.49] - 2026-03-13
### Fixed
- fix: eliminate N+1 queries in blockSync by restoring L2 config JOINs (#677)


## [5.17.48] - 2026-03-13
### Fixed
- fix: increase timeout for RPC block fetch operations to prevent timeouts (#673)
- fix(blog): shorten description to ≤160 chars, add build validation to pipeline (#672)
...
- blog: regenerate cover images with consistent style
- fix(blog): improve cover image generation prompt to match existing style
- fix(blog): improve cover image generation prompt to match existing style
- blog: regenerate cover images to match existing style


## [5.17.44] - 2026-03-13
### Fixed
- fix: restore ERC-20 token transfer processing (#666)


## [5.17.43] - 2026-03-13
### Fixed
- fix: handle all 'failed response' errors from Hyperliquid (#664)
...
## [5.17.39] - 2026-03-12
### Fixed
- blog: regenerate cover images with brighter background
- blog: regenerate cover images for who-evaluates-the-agent-erc-8183
...
- fix: eliminate N+1 database query regression in blockSync cached path (#637)
- Blog trend scanning pipeline (#622)
- fix: increase postgres health check timeout from 5s to 10s


## [5.17.36] - 2026-03-12
### Fixed
- fix: add id-token:write permission to infra-auto-remediation workflow
...
## [5.17.31] - 2026-03-11
### Fixed
- feat: replace Ghost blog with Astro app at /blog (#593)


## [5.17.30] - 2026-03-11
### Fixed
- fix: use Sentry v8-compatible tracesSampler API to fix app crash
...
## [5.17.27] - 2026-03-11
### Fixed
- fix: add removeOnFail configuration to prevent Redis OOM (#599)
...
## [5.17.24] - 2026-03-10
### Fixed
- fix: optimize blockSync database query performance (#592)
...
- fix: eliminate N+1 query pattern in blockSync workspace lookup (#566)
- fix: optimize processBlock job database queries (#567)
- fix: eliminate N+1 query in blockSync job for Orbit withdrawals (#579)
...
- fix: eliminate N+1 query in block processing (#575)
- fix: optimize processTokenTransfer query performance (#573)


## [5.17.18] - 2026-03-10
### Fixed
- fix: increase stall tolerance for high-priority BullMQ jobs (#569)


## [5.17.17] - 2026-03-10
### Fixed
- fix: eliminate N+1 query pattern in storeTokenBalanceChanges (#562)


## [5.17.16] - 2026-03-09
### Fixed
- fix: optimize receiptSync performance by lazy loading orbit/OP configs (#558)


## [5.17.15] - 2026-03-09
### Fixed
- fix: add continue-on-error to conversation streamer steps
- feat: Claude sessions dashboard with real-time streaming (#554)
- fix: optimize Workspace query in blockSync job to reduce query time (#557)


## [5.17.14] - 2026-03-09
### Fixed
- fix: increase timeout for external API calls in job processing (#552)
...
## [5.17.9] - 2026-03-09
### Fixed
- fix: improve scanner efficiency, fix auto-resolve, increase max-turns (#525)


## [5.17.8] - 2026-03-09
### Fixed
- fix: verify review comments before reacting with emoji (#521)
- fix: combine scanners into single hourly job, fix statsPeriod, add regression priority (#522)
- fix: optimize blockSync DB queries to reduce latency from 130ms+ to <50ms (#519)
...
- fix: handle database connection errors in updateExplorerSyncingProcess job (#480)
...
- fix: handle invalid JSON in processTransactionError job (#494)
...
- fix: prevent database connection timeouts in increaseStripeBillingQuota job (#499)
- fix: handle invalid JSON in processTransactionError job (#494)
- fix: handle database connection errors in Explorer quota methods (#490)
- fix: add retry logic for database connection errors in removeStalledBlock (#492)
- fix: apply gasPrice fallback in bulk transaction creation (#482)
...
- fix: add retry logic for database connection errors in removeStalledBlock (#492)
- fix: apply gasPrice fallback in bulk transaction creation (#482)
- fix: add missing transaction parameters in safeCreatePartialBlock (#483)
...
### Fixed
- fix: add missing transaction parameters in safeCreatePartialBlock (#483)
- fix: add complete pool configuration to prevent database connection termination (#481)
...
## [5.16.7] - 2026-03-06
### Fixed
- fix: handle null gasPrice in transactions for EIP-1559 compatibility (#472)


## [5.16.6] - 2026-03-06
### Fixed
- fix: handle RPC block size errors in ProviderConnector (#471)
- fix: remove unsupported pull_request_review_thread trigger
- fix: complete workflow_dispatch support for sentry auto-fix pipeline
- fix: restore issues.opened trigger + update CLAUDE.md sentry docs
- feat: detect Sentry regressions and link to previous fix PRs
- fix: move Sentry resolution after deploy to avoid regression reopening
- feat: resolve Sentry issue when fix PR is merged
- fix: debounce process-review to handle rapid Greptile events
- fix: dead code in Tracer error handling + workflow thread trigger


## [5.16.5] - 2026-03-06
### Fixed
- fix: handle RPC rate limiting and block size errors gracefully (#461)
- fix: validate number input in searchForNumber to prevent database error (#462)
- fix: WebSocket 404 error - add path prefix for Caddy routing (#460)
- fix: process-review job triggers and bash syntax error
- fix: prevent duplicate Sentry Auto-Fix workflow runs
...
## [5.16.2] - 2026-03-06
### Fixed
- Add proper landing page images (avatars, NFTs) blocked by .git/info/exclude rules
- Revert accidental landing page component regression
...
## [5.15.2] - 2026-03-05
### Added
- Sentry queue monitoring spans (`queue.publish`/`queue.process`) for BullMQ workers
- Frontend Sentry build args in Dockerfile.caddyfile and CI workflow

## [5.15.1] - 2026-03-04
### Changed
- Fix pricing page to match actual DB plan capabilities (Starter/Team/App Chain)
- Add transaction quota pill to pricing cards
- Add Use Cases mega dropdown to navbar (Developers, Teams, App Chains)
- Reorder navbar: Features / Integrations / Use Cases / Pricing / Contact
- Rewrite Developers, Teams, and App Chains pages with browser preview mockups
...
- Fix app.ethernal.com references to app.tryethernal.com in landing site

## [5.14.2] - 2026-03-04
### Changed
- Serve landing site directly from Caddy on Fly.io, removing Netlify dependency
- Add PostHog and Sentry proxy rules to Caddyfile

## [5.14.1] - 2026-03-04
### Changed
- Switch Netlify deploy from app frontend to landing site
...
## [5.12.6] - 2026-03-02
### Fixed
- OP Stack settings update failing with "Selected parent workspace is not a valid L1 parent" for custom L1 parents

## [5.12.5] - 2026-03-02
### Fixed
- Block confirmations on transaction page now update in real-time instead of staying fixed at page load value

## [5.12.4] - 2026-03-02
### Changed
- Faster receipt syncing with batch RPC calls and inline storage for small blocks
- Reduced database load during receipt sync by caching workspace data across jobs
...
### Changed
- Better check if we should process token transfer
...
## [5.3.12] - 2025-07-05
### Fixed
- L1 block link styling

## [5.3.11] - 2025-07-05
### Fixed
- Alignments issue on small screens on transaction page

## [5.3.10] - 2025-07-04
### Fixed
- tryethernal.com subdomains displayed in the explorer details pages

## [5.3.9] - 2025-07-04
### Fixed
- tryethernal.com subdomains displayed in the explorers list

## [5.3.8] - 2025-07-04
### Fixed
- tryethernal.com subdomains displayed in the explorers list
- Cleaner & simpler explorer creation internal frontend flow
...
## [5.3.4] - 2025-07-02
### Fixed
- Demo migration redirection bug

## [5.3.3] - 2025-07-02
### Fixed
- Bugs related to demo migration
...
## [5.3.1] - 2025-07-02
### Fixed
- Bugs related to plan switching

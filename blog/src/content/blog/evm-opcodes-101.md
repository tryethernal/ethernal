...
description: "EVM opcodes are the low-level instructions behind every Ethereum transaction. Learn how stack, memory, storage, and gas costs work."
image: "/blog/images/evm-opcodes-101.png"
ogImage: "/blog/images/evm-opcodes-101-og.png"
tags:
  - EVM
  - Ethereum
  - Smart Contracts
...
<span id="fn-1">1.</span> Ethereum Foundation. "RLP Serialization." _ethereum.org_, 2024. [https://ethereum.org/developers/docs/data-structures-and-encoding/rlp/](https://ethereum.org/developers/docs/data-structures-and-encoding/rlp/)

<span id="fn-2">2.</span> Ethereum Foundation. "Transactions." _ethereum.org_, 2024. [https://ethereum.org/developers/docs/transactions/](https://ethereum.org/developers/docs/transactions/)

<span id="fn-3">3.</span> Wood, G. "Ethereum: A Secure Decentralised Generalised Transaction Ledger (Yellow Paper)." _ethereum.github.io_, 2024. [https://ethereum.github.io/yellowpaper/paper.pdf](https://ethereum.github.io/yellowpaper/paper.pdf)

<span id="fn-4">4.</span> Ethereum Foundation. "Patricia Merkle Tries." _ethereum.org_, 2024. [https://ethereum.org/developers/docs/data-structures-and-encoding/patricia-merkle-trie/](https://ethereum.org/developers/docs/data-structures-and-encoding/patricia-merkle-trie/)

<span id="fn-5">5.</span> EVM Codes Contributors. "EVM Opcodes Interactive Reference." _evm.codes_, 2024. [https://www.evm.codes/](https://www.evm.codes/)

<span id="fn-6">6.</span> Buterin, V. and Swende, M. "EIP-2929: Gas Cost Increases for State Access Opcodes." _Ethereum Improvement Proposals_, 2020. [https://eips.ethereum.org/EIPS/eip-2929](https://eips.ethereum.org/EIPS/eip-2929)

<span id="fn-7">7.</span> Buterin, V. "A Theory of Ethereum State Size Management." _ethresear.ch_, 2021. [https://ethresear.ch/t/a-theory-of-ethereum-state-size-management/9292](https://ethresear.ch/t/a-theory-of-ethereum-state-size-management/9292)

<span id="fn-8">8.</span> Buterin, V. and Swende, M. "EIP-3529: Reduction in Refunds." _Ethereum Improvement Proposals_, 2021. [https://eips.ethereum.org/EIPS/eip-3529](https://eips.ethereum.org/EIPS/eip-3529)

<span id="fn-9">9.</span> Solidity Team. "Solidity v0.8.4 Release: Custom Errors." _soliditylang.org_, 2021. [https://soliditylang.org/blog/2021/04/21/custom-errors/](https://soliditylang.org/blog/2021/04/21/custom-errors/)

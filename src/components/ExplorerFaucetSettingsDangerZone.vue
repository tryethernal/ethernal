        ...
        <v-card class="elevation-0">
            ...
            <v-card-text class="font-weight-medium text-error">
                <v-row>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn size="small" variant="flat" color="error" class="mt-2" @click="openExplorerFaucetPrivateKeyExportModal()"><v-icon class="mr-1">mdi-export</v-icon>Export Private Key</v-btn>
                </v-row>
                <v-divider class="my-5"></v-divider>
                <v-row>
                    Deleting the faucet is irreversible, if you haven't exported the private key before, funds will be lost.
                    <v-spacer></v-spacer>
                    <v-btn :loading="loading" size="small" variant="flat" color="error" class="mt-2" @click="deleteFaucet()"><v-icon class="mr-1">mdi-delete</v-icon>Delete Faucet</v-btn>
                </v-row>
            </v-card-text>
        </v-card>
    </v-sheet>

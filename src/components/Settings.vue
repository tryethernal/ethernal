    ...
    <v-container fluid>
        <v-card class="pa-4">
            <v-tabs v-model="tab" class="mb-2">
                ...
                <v-tab v-if="envStore.isBillingEnabled && !envStore.isSelfHosted" class="text-medium-emphasis" color="primary" value="billing">Billing</v-tab>
            ...
            <v-tabs-window v-model="tab">
                ...
                <v-tabs-window-item v-if="envStore.isBillingEnabled && !envStore.isSelfHosted" value="billing">
                    <Billing />
                </v-tabs-window-item>

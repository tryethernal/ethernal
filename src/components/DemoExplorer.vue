        ...
        <v-main>
            <v-container>
                        ...
                        <v-card outlined>
                            ...
                            <v-card-text>
                                ...
                                <p>
                                    ...
                                    If you want to set it up permanently, you can sign-up <a href="https://app.tryethernal.com" target="_blank">here</a>.
                                </p>
                                <p>
                                    With the full version you'll be able to:
                                    <ul>
                                        <li>Use your own domain names</li>
                                        <li>Customize the logo, colors, links, fonts, etc...</li>
                ...
                <v-row v-if="domain">
                    <v-col>
                        <v-card outlined>
                            <v-card-title>Your explorer is ready!</v-card-title>
                            <v-card-text>
                                You can access it here: <a :href="`//${this.domain}`" target="_blank">{{ this.domain }}</a>
                            </v-card-text>
                        </v-card>
                    </v-col>
                </v-row>
    ...
    methods: {
        submit() {
            ...
            this.server.createDemoExplorer(this.name, this.rpcServer, this.nativeToken)
                .then(({ data }) => this.domain = data.domain)
                .catch(error => this.errorMessage = error.response && error.response.data || 'Error while creating explorer. Please retry.')

...
if (isEthernalDomain) {
    ...
    if (!publicExplorerSlug.endsWith('app') || (window.location.host != process.env.VUE_APP_STAGING_DOMAIN) && window.location.host.endsWith(process.env.VUE_APP_STAGING_DOMAIN))

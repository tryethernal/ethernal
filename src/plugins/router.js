...
const routes = [
    ...
    { path: '/address/:hash/:index', component: ERC721Token, props: true, beforeEnter: redirectIfLoggedOut },
    { path: '/token/:hash/:index', component: ERC721Token, props: true, beforeEnter: redirectIfLoggedOut },

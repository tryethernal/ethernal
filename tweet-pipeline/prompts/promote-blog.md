...
- Casual tone. First letter MUST be uppercase (like a regular sentence). Rest is lowercase except proper nouns.
- Company voice: no first-person "I". Use "we" only for Ethernal-specific actions. State observations as confident facts.
- No hashtags, no emoji, no "we're excited", no "check out our latest"
- End with a short transition to the link, like: "full breakdown →", "full investigation →", "full article →", "deep dive →". Pick whichever fits the content's tone.

...
describe('FormattedSolVar.vue', () => {
    it('Should remove link styling', () => {
        const wrapper = mount(FormattedSolVar, {
            props: {
                input: { type: 'address' },
                value: '0x123',
                notInteractive: true
    ...
    it('Should display links as a tag', () => {
        const wrapper = mount(FormattedSolVar, {
            props: {
                input: { type: 'string' },
    ...
    it('Should display svg as an image', () => {
        const wrapper = mount(FormattedSolVar, {
            props: {
                input: { type: 'string' },
    ...
    it('Should display an address with Hash-Link element', () => {
        const wrapper = mount(FormattedSolVar, {
            props: {
                input: { type: 'address' },
                value: '0x123'
    ...
    it('Should not be switchable if type is uint256', () => {
        const wrapper = mount(FormattedSolVar, {
            props: {
                input: { type: 'uint256' },
    ...
    it('Should display the name of the variable if passed', () => {
        const wrapper = mount(FormattedSolVar, {
            props: {
    ...
    it('Should switch the value to raw hash', async () => {
        const wrapper = mount(FormattedSolVar, {
            props: {
                input: { type: 'address' },
                value: '0x123'

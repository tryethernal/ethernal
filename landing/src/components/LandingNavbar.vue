    ...
    <header class="landing-navbar" :class="{ scrolled }">
        <div class="navbar-inner">
            ...
            <nav class="navbar-links d-none d-md-flex">
                ...
                <a href="https://doc.tryethernal.com" target="_blank" class="nav-link">Docs</a>
            ...
            <div class="navbar-actions d-none d-md-flex">
                <a href="https://github.com/tryethernal/ethernal" target="_blank" class="nav-link github-link" aria-label="GitHub">

<template>
    <LandingLayout>
            ...
            <FeatureSection inline-icon compact icon="mdi-github" title="CI-Friendly Setup" description="Run Hardhat or Anvil in your GitHub Actions workflow and sync transactions to Ethernal. Every CI run gets its own workspace so you can see exactly what your test suite did on-chain.">
                <template #visual>
                    <div class="browser-preview">
                        <div class="preview-header"><div class="d-flex align-center ga-2"><span class="dot red"></span><span class="dot yellow"></span><span class="dot green"></span></div><div class="preview-url-bar"><v-icon size="12" style="color: #64748B;">mdi-lock</v-icon>.github/workflows/test.yml</div><div style="width: 42px;"></div></div>
        ...
        <section style="background: rgba(17, 24, 39, 0.5); border-top: 1px solid rgba(61, 149, 206, 0.08); padding: 80px 0;">
            <v-container style="max-width: 600px;">
                <div class="text-center mb-8">
                    <h2 class="font-heading mb-3" style="font-weight: 700; font-size: clamp(1.4rem, 3vw, 1.8rem); color: #F1F5F9; letter-spacing: -0.02em;">Need a Custom CI Integration?</h2>
...
.mock-ws { display: flex; align-items: center; justify-content: space-between; padding: 10px 12px; border-radius: 8px; border-bottom: 1px solid rgba(61, 149, 206, 0.05); }
.mock-ws:hover { background: rgba(11, 17, 32, 0.4); }
.ws-name { color: #F1F5F9; font-size: 12px; font-weight: 500; }
...
.ws-time { color: #64748B; font-size: 10px; }

/* Contact form */
.contact-card { background: rgba(17, 24, 39, 0.7); backdrop-filter: blur(12px); border: 1px solid rgba(61, 149, 206, 0.22); border-radius: 16px; padding: 32px; }
